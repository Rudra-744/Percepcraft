  ...
  useEffect(() => {
    const handleScroll = () => {
      const newOffsets = cardRefs.map((ref) => {
        ...
        // Return a parallax offset (adjust 0.1 for intensity)
    ...
    >
      <div className="max-w-[1500px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 lg:mb-24">
          ...
          <h2 id="page4-heading" className="text-5xl sm:text-6xl lg:text-[72px] font-bold text-[#111111] leading-[1.1] tracking-tight">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full overflow-hidden rounded-[32px] bg-gray-100">
                ...
                >
                  {/* Zoom on Hover + Parallax Offset applied to parent */}
